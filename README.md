...
| `Capture network logs content` | Capture request and response content (bodies) in network logs, not just metadata. Automatically enables **Network logs**. | Optional | `false` |
